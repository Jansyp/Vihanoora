...
DEFAULT_SETTINGS = {
    ...
    "home_sections": [
        {"key": "trending", "label": "Trending on Instagram", "enabled": True, "order": 1, "theme": "white"},
        {"key": "best_sellers", "label": "Best Sellers", "enabled": True, "order": 2, "theme": "cream"},
        {"key": "offer_banner", "label": "Offer Zone Banner", "enabled": True, "order": 3, "theme": "cream"},
        {"key": "new_arrivals", "label": "New Arrivals", "enabled": True, "order": 4, "theme": "cream"},
        {"key": "gift_picks", "label": "Gift Picks", "enabled": True, "order": 5, "theme": "blush"},
        {"key": "combos", "label": "Combo Offers", "enabled": True, "order": 6, "theme": "cream"},
        {"key": "instagram", "label": "Instagram Gallery", "enabled": True, "order": 7, "theme": "white"},
        {"key": "reviews", "label": "Customer Reviews", "enabled": True, "order": 8, "theme": "sage"},
        {"key": "newsletter", "label": "Newsletter", "enabled": True, "order": 9, "theme": "cream"},
    ],
}
