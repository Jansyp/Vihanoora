  ...
  return (
    <div>
      <section className="bg-gradient-to-b from-[var(--blush)] to-[var(--cream)] py-14 text-center px-4">
        ...
        <a href={settings?.instagram_url || "#"} target="_blank" rel="noreferrer" className="inline-block mt-6 px-7 py-3.5 rounded-full bg-[var(--ink)] text-white font-medium">Follow @Viaura</a>
      </section>
